...
const ResetPassword = () => {
    ...
    const { backendURL } = useContext(AppContext);   // ✅ fixed typo here
    ...
    const handlePaste = (e) => {
        ...
        if (inputRef.current[next]) inputRef.current[next].focus();
    };
        ...
        >
            ...
            {!isOtpSubmitted && isEmailSent && (
                <div className="p-5 rounded-4 shadow bg-white" style={{ width: "400px" }}>
                    ...
                    <button className="btn btn-primary w-100 fw-semibold" onClick={handleVerify}>
                        Verify email
                    </button>
                </div>
            )}
