package insnehacoddep.AuthFort.service;
...
public class EmailService {
    ...
    private String fromEmail; // Must match verified Brevo sender
...
//            helper.setText(
//                    "Your OTP for resetting your password is " + otp + ". Use this OTP to proceed.",
//                    false
//            );
//
//            mailSender.send(mimeMessage);
